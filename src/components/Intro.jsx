    ...
    >
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center items-center">
        ...
        <motion.div 
          ...
          className="absolute z-10 top-[12%] md:top-[14%] lg:top-[12%] flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto space-y-3 md:space-y-6 pointer-events-auto"
        >
          {/* Glassmorphic Badge */}
