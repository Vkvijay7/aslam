  ...
  return (
    <section id="contact-us" className="pt-12 md:pt-16 pb-16 md:pb-24 bg-white text-[#120F17] relative overflow-hidden scroll-mt-20 border-b border-black/5">
      ...
      <div className="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
        ...
        <div className="flex flex-row md:grid md:grid-cols-12 gap-3 md:gap-16 items-stretch md:items-center">
          
          {/* Left Block (Profile Image frame - Reduced Size similar to About Us) */}
          <ScrollReveal direction="left" delay={0.1} className="w-[42%] md:w-auto md:col-span-4 relative max-w-[220px] sm:max-w-[260px] md:max-w-[280px] lg:max-w-[240px] mx-auto w-full">
          ...
          <ScrollReveal direction="right" delay={0.2} className="w-[58%] md:w-auto md:col-span-8 flex flex-col gap-4 justify-between h-full md:h-auto">
            
            {/* Info & Location Badge directly above cards */}
            <div className="space-y-3 text-left">
              <p className="font-paragraph text-[8px] xs:text-[9.5px] md:text-base text-[#120F17]/80 leading-relaxed">
              ...
              <div className="flex items-center justify-start gap-2">
                <div className="flex items-center gap-1 md:gap-2 text-[8px] xs:text-[9px] md:text-sm font-semibold text-evergreen/90 bg-evergreen/5 px-2 py-1 md:px-3 md:py-1.5 rounded-full w-max border border-evergreen/10">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-6 pt-4 border-t border-black/5">
              ...
              <div className="bg-[#F8F9FA] border border-black/5 p-3 md:p-6 rounded-xl md:rounded-3xl flex flex-col justify-between flex-1 md:flex-initial md:h-auto">
                <div>
                  ...
                  <h4 className="font-nav-link text-[10px] xs:text-xs md:text-lg font-bold text-[#120F17] uppercase tracking-wide mt-1.5">Direct Phone</h4>
                  <p className="font-paragraph text-[8px] xs:text-[9px] md:text-sm text-[#120F17]/70 leading-snug mt-1.5">
                ...
                <div className="pt-2">
                  <a 
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 md:px-6 md:py-3 bg-black hover:bg-evergreen text-white font-nav-link text-[8px] xs:text-[9px] md:text-xs uppercase font-bold rounded-lg md:rounded-full tracking-wider transition-all active:scale-95 shadow-sm w-full justify-center"
                  >
              ...
              <div className="bg-[#F8F9FA] border border-black/5 p-3 md:p-6 rounded-xl md:rounded-3xl flex flex-col justify-between flex-1 md:flex-initial md:h-auto">
                <div>
                  ...
                  <h4 className="font-nav-link text-[10px] xs:text-xs md:text-lg font-bold text-[#120F17] uppercase tracking-wide mt-1.5">WhatsApp Chat</h4>
                  <p className="font-paragraph text-[8px] xs:text-[9px] md:text-sm text-[#120F17]/70 leading-snug mt-1.5">
                ...
                <div className="pt-2">
                  <a 
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 md:px-6 md:py-3 bg-[#25D366] hover:bg-evergreen text-white font-nav-link text-[8px] xs:text-[9px] md:text-xs uppercase font-bold rounded-lg md:rounded-full tracking-wider transition-all active:scale-95 shadow-sm w-full justify-center"
                  >
